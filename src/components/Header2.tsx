...
export default function Nav() {
  ...
  {/* <p className="text-black text-sm bg-white"></p> */}
      ...
      <div className="flex md:gap-4 sm:gap-3 gap-2">
        <Link href="/contact-us" className="hover:text-gray-800">Find a Store</Link>
    ...
    <div className="flex flex-wrap justify-between items-center px-6 py-4">
      ...
      <div className="flex items-center gap-4 mt-4 md:mt-0">
        ...
        <Link href="/cart"><FaHeart className="text-gray-700 md:w-[24px] md:h-[24px] sm:w-[20px] sm:h-[20px] w-[16px] h-[16px]  cursor-pointer hover:text-black" /> </Link>
