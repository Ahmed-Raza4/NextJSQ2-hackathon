                ...
                <div className="w-full lg:flex-[0.65]">
                    ...
                    {/* <form onSubmit={}> */}
                        ...
                        <button
                            ...
                            className={`w-full py-3 mt-6 rounded-md text-[16px] font-[600] ${isFormValid ? "bg-blue-500 text-white hover:bg-blue-600" : "bg-gray-300 text-white"
                                }`}
                    ...
                    <div className="border p-4 rounded-md shadow-sm">
                        ...
                        <div className="border-t pt-4 mt-4">
                            ...
                            <div className="flex justify-between mt-2">
                                ...
                                <p className="text-[16px] font-[600]">{deliveryFee == 0 ? "Free" : "₹ 500"}</p>
                            </div>
